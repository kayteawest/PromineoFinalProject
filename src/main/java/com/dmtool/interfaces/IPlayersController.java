...
public interface IPlayersController {
	...
	int createPlayerCharacter(@PathVariable int playerId,
			@RequestBody CreatePlayerCharacterRequest createPlayerCharacterRequest);
	...
	@ResponseStatus(code = HttpStatus.OK)
	PlayerCharacter getPlayerCharacter(@PathVariable int playerId, @PathVariable int playerCharacterId);
	...
	@ResponseStatus(code = HttpStatus.OK)
	void updatePlayerCharacter(@PathVariable int playerId, @PathVariable int playerCharacterId,
			@RequestBody UpdatePlayerCharacterRequest updatePlayerCharacterRequest);
